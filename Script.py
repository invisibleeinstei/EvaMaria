class script(object):
    START_TXT = """<b>Hey {},
My Name is <a href=https://t.me/{}>{}</a>,I'm simple Filter Bot With Advanced Functions. 🐥🌳</b>"""
    HELP_TXT = """𝐇𝐞𝐞𝐞.{} 👻
...
✯ ʙᴜɪʟᴅ ꜱᴛᴀᴛᴜꜱ�: v1.0.1 [ʙᴇᴛᴀ]"""
    SOURCE_TXT = """<b>Heee.Source Is Not Available 😓❤️‍🔥</b>
 𝐎𝐨𝐨𝐩𝐬.𝐒𝐨𝐫𝐫𝐲 𝐈 𝐚𝐦 𝐧𝐨𝐭 𝐚 𝐨𝐩𝐞𝐧 𝐬𝐨𝐮𝐫𝐜𝐞 𝐩𝐫𝐨𝐣𝐞𝐜𝐭.𝐩𝐥𝐞𝐚𝐬𝐞 𝐏𝐌 𝐌𝐲 𝐟𝐚𝐭𝐡𝐞𝐫.<a href=https://t.me/invisible_einstein>ɪɴᴠɪꜱɪʙʟᴇ ᴇɪɴꜱᴛᴇɪɴ |ᴵᴱ ⚡️</a>
