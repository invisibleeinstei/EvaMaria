class script(object):
    START_TXT = """𝐇𝐞𝐲 {},
𝐌𝐲 𝐍𝐚𝐦𝐞 𝐢𝐬 <a href=https://t.me/{}>{}</a>,𝐈'𝐦 𝐅𝐚𝐬𝐭 𝐅𝐢𝐥𝐭𝐞𝐫 𝐁𝐨𝐭 𝐖𝐢𝐭𝐡 𝐀𝐝𝐯𝐚𝐧𝐜𝐞𝐝 𝐅𝐮𝐧𝐜𝐭𝐢𝐨𝐧𝐬... 🚀

<b>ᴀʟᴡᴀʏꜱ ꜱɪᴍᴘʟᴇ ᴀɴᴅ ꜰᴀꜱᴛ ᴀʟʟ ᴀʟ ᴋᴜᴘᴘɪʏᴀ ʙᴏᴛꜱ.🐣
ʟɪꜰᴇ ɪꜱ ʟᴇᴀʀɴɪɴɢ.🌟</b>"""
    HELP_TXT = """𝐇𝐞𝐞𝐞.{} 👻
...
<b>NOTE:</b>
these are the extra features of My
...
★ 𝐓𝐨𝐭𝐚𝐥 𝐔𝐬𝐞𝐫𝐬: <code>1278</code>🙋🏻‍♂️
★ 𝐓𝐨𝐭𝐚𝐥 𝐂𝐡𝐚𝐭𝐬: <code>35</code>💁🏻‍♂️🎈
